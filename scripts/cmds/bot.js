...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  var Messages = ["𝐇𝐞𝐲 𝐘𝐨𝐮 𝐀𝐫𝐞 𝐒𝐨 𝐁𝐞𝐚𝐮𝐭𝐢𝐟𝐮𝐥", "𝐈 𝐋𝐨𝐯𝐞 𝐘𝐨𝐮🙂", "𝐘𝐞𝐬 𝐃𝐞𝐚𝐫, 𝐈 𝐀𝐦 𝐇𝐞𝐫𝐞...😗", "𝐌𝐢𝐬𝐬 𝐘𝐨𝐔 𝐁𝐞𝐩𝐩𝐲🥹", "😁𝐒𝐦𝐢𝐥𝐞 𝐈'𝐚𝐦 𝐓𝐚𝐤𝐢𝐧𝐠 𝐒𝐞𝐥𝐟𝐲✌️🤳", "𝐁𝐥𝐨𝐜𝐤 𝐘𝐨𝐮𝐫 𝐁𝐚𝐛𝐞 𝐀𝐧𝐝 𝐏𝐮𝐫𝐩𝐨𝐬𝐞 𝐦𝐞🙂💔", "𝐉𝐚𝐧 𝐤𝐦𝐧 𝐀𝐬𝐨 𝐡𝐞𝐚🫣", "𝐈 𝐒𝐞𝐞 𝐘𝐨𝐮 𝐈𝐧𝐬𝐢𝐝𝐞 𝐄𝐯𝐞𝐫𝐲𝐨𝐧𝐞😎", "𝐓𝐡𝐚𝐭'𝐬 𝐖𝐡𝐲 𝐈 𝐋𝐨𝐯𝐞 𝐄𝐯𝐞𝐫𝐲𝐨𝐧𝐞 𝐀𝐬 𝐌𝐨𝐫𝐞 𝐀𝐬 𝐘𝐨𝐮🤭","𝐄𝐯𝐞𝐫𝐲𝐛𝐨𝐝𝐲 𝐖𝐚𝐧𝐧𝐚 𝐒𝐭𝐞𝐚𝐥 𝐌𝐲 𝐁𝐨𝐲𝐲😫", "আমি আপনাকে কিভাবে সাহায্য করতে পারি...? 🤔", "আদেশ করুন বস...🙂", "হুম শুনছি আমি আপনি বলুন 😐", "আমার সব কমান্ড দেখতে.help টাইপ করুন ✅", "𝐉𝐢 𝐛𝐨𝐥𝐞𝐧 𝐤𝐢 𝐤𝐨𝐫𝐭𝐞 𝐩𝐚𝐫𝐢 𝐚𝐦𝐢 𝐚𝐩𝐧𝐚𝐫 𝐣𝐨𝐧𝐧𝐨...?", "আদেশ করুন যাহাপানা 😎", "আবার যদি আমারে বট কইয়া ডাক দেছ তাইলে তোর বিয়ে হবে না 🫤😏", "𝐈'𝐚𝐦 𝐲𝐨𝐮𝐫 𝐩𝐞𝐫𝐬𝐨𝐧𝐚𝐥 𝐚𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐭", "তুই বট তোর নানি বট 😤 তোর কত বড় সাহস তুই আমারে বট কস 😤 তোর টা খাই নাকি পড়ি যে তুই আমারে বট কস 😤", "আপনার কি চরিত্রে সমস্যা যে এতো বার আমাকে ডাকতেছেন 🤨", "ডাকছোত কেন ফাস্ট কো 😒", "তুমি কি আমাকে ডেকেছো...? 😇"];
